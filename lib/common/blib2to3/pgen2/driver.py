...
import pkgutil
import sys
from typing import Any, IO, Iterable, List, Optional, Text, Tuple, Union
...
class Driver(object):
    def __init__(self, grammar: Grammar, convert: Optional[_Convert] = None, logger: Optional[Logger] = None) -> None:
