...
from typing import AnyStr, Callable, Collection, Iterable, TYPE_CHECKING, Union

from .pathspec import PathSpec
from .pattern import Pattern
from .patterns.gitwildmatch import GitWildMatchPattern
...
class GitIgnoreSpec(PathSpec):
    ...
    def from_lines(
        ...
        *pattern_factory* can be :data:`None`, the name of a registered
        ...
        elif (isinstance(lines, str) or callable(lines)) and _is_iterable(
            pattern_factory
        ):
